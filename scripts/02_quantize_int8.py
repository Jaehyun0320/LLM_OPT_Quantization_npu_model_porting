...
parser.add_argument("--output", type=str, default="results/quant_int8.json")
parser.add_argument(
    "--attn-implementation",
    type=str,
    default="eager",
...
if device != "cuda":
    raise RuntimeError(
        "02_quantize_int8.py uses bitsandbytes INT8 quantization and should be "
        "run on an NVIDIA CUDA GPU. Use 01_baseline.py for local CPU/MPS smoke tests."
    )
...
result = {
    ...
    "model_size": {
        ...
        "parameter_storage_mb": param_size_mb,
        "note": "Approximate parameter tensor storage size for bitsandbytes model.",
    },
    "memory": {
